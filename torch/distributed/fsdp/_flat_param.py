...
class FlatParamHandle:
    ...
    def _get_flat_param_name(self) -> str:
        ...
        """
        # Replace "." with "_" since "." is not permitted in a parameter name
        return "flat_param:" + ",".join(
            prefixed_param_name.replace(".", "_")
            for prefixed_param_name in self.flat_param._prefixed_param_names
        )
